...
public class FeedController {
	...
	@GetMapping("/post/{id}")
	public ResponseEntity<AppApiResponse<FeedResponse>> getPostById(@PathVariable String id, HttpServletRequest httpServletRequest) {
		String token = jwtService.extractTokenFromHeader(httpServletRequest);
	...
	@Operation(
			...
			description = "Retrieve a single challenge by its ID")
	@ApiResponses(
			value = {
					@ApiResponse(
							responseCode = "200",
	...
	public ResponseEntity<AppApiResponse<FeedResponse>> getChallengeById(@PathVariable String id, HttpServletRequest httpServletRequest) {
		String token = jwtService.extractTokenFromHeader(httpServletRequest);
		String email = jwtService.extractEmail(token);
