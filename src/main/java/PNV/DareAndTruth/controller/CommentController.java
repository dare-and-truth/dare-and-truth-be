...
public class CommentController {
    ...
    @PostMapping
    public ResponseEntity<AppApiResponse<Void>> commentFeed(@Valid @RequestBody CreateCommentRequest request, HttpServletRequest httpServletRequest) {
    ...
    public ResponseEntity<AppApiResponse<Set<CommentSummaryProjection>>> getCommentsByFeedId(@PathVariable String feedId) {
