...
public class Score extends BaseEntity {
     ...
     * 1 = Ranking(1st:100,2nd:70,3rd:50,other:30, 2 = Daily challenge completion(posted:10), 3 = Daily Login(5days:20,10days:50), 4 = Number of participants in a challenge(>=1peo: 10, >=10peo: 30, >=100peo 50, >=10000peo: 100), etc.
     */
